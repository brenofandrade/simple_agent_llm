...
## Instalação rápida
Use o script de instalação para evitar o erro do pip (`AssertionError: len(weights) == expected_node_count`) observado em versões 25.x. Ele fixa o pip em uma versão estável antes de instalar as dependências.
